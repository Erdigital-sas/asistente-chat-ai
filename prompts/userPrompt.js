...
SEÑALES VISIBLES DEL CHAT
- ultimo_role_visible: ${caso?.chatSignals?.ultimo_role_visible || "ninguno"}
- hay_clienta_visible: ${caso?.chatSignals?.hay_clienta_visible ? "sí" : "no"}
- solo_operador_visible: ${caso?.chatSignals?.solo_operador_visible ? "sí" : "no"}
...
${feedback ? `CORRECCION OBLIGATORIA\n${feedback}\n` : ""}
